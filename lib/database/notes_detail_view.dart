...
import 'package:printer_app/database/app_database.dart';
  ...
  refreshNotes() {
    ...
    noteDatabase.read(widget.noteId!).then((value) {
      setState(() {
        ...
        // titleController.text = note.createdTime!.toIso8601String();
        // contentController.text = note.createdTime!.toIso8601String();
